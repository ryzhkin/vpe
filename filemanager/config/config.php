...
$upload_dir = '/uploads/news/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../uploads/news/'; // relative path from filemanager folder to upload folder (with final /)
...
$access_keys = array('esy5v3cpepcskc00k8owg0oc0ksso0c');
